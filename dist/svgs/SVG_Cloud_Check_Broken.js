...
const SVG_Cloud_Check_Broken = (props) => {
    ...
    return (React.createElement("svg", { className: className, fill: "none", height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
        ...
        React.createElement("path", { d: "M10 19.8L11.1429 21L14 18", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.5" })));
};
export default SVG_Cloud_Check_Broken;
