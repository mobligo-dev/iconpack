...
const SVG_Bill_Check_Broken = (props) => {
    ...
    return (React.createElement("svg", { className: className, fill: "none", height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
        ...
        React.createElement("path", { d: "M9.5 10.4L10.9286 12L14.5 8", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.5" }),
        React.createElement("path", { d: "M7.5 15.5H9M16.5 15.5H12", "stroke-linecap": "round", "stroke-width": "1.5" })));
};
export default SVG_Bill_Check_Broken;
