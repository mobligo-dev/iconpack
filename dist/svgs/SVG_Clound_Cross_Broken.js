...
const SVG_Clound_Cross_Broken = (props) => {
    ...
    return (React.createElement("svg", { className: className, fill: "none", height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
        ...
        React.createElement("path", { d: "M13.5 17.5L12 19M12 19L10.5 20.5M12 19L10.5 17.5M12 19L13.5 20.5", "stroke-linecap": "round", "stroke-width": "1.5" })));
};
export default SVG_Clound_Cross_Broken;
