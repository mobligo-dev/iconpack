...
const SVG_Cloud_Minus_Broken = (props) => {
    ...
    return (React.createElement("svg", { className: className, fill: "none", height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
        ...
        React.createElement("path", { d: "M14 19H12L10 19", "stroke-linecap": "round", "stroke-width": "1.5" })));
};
export default SVG_Cloud_Minus_Broken;
