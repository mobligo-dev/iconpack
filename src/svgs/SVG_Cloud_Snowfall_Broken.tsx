...
const SVG_Cloud_Snowfall_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12.001 15V22" stroke-linecap="round" stroke-width="1.5"/>
<path d="M9.00293 16.7314L15.0016 20.1948" stroke-linecap="round" stroke-width="1.5"/>
<path d="M14.999 16.7314L9.00031 20.1948" stroke-linecap="round" stroke-width="1.5"/>
