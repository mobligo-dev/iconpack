...
const SVG_Bill_List_Linear = (props: { className: any }) => {
...
<path d="M10.5 7.5H17" stroke-linecap="round" stroke-width="1.5"/>
<path d="M10.5 14.5H17" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
