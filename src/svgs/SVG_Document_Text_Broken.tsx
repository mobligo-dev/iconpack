...
const SVG_Document_Text_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M8 12H9M16 12H12" stroke-linecap="round" stroke-width="1.5"/>
<path d="M16 8H15M12 8H8" stroke-linecap="round" stroke-width="1.5"/>
