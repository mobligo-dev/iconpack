...
const SVG_Recive_Square_Linear = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M7 12L14 12M14 12L11 15M14 12L11 9" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
<path d="M17 16L17 8" stroke-linecap="round" stroke-width="1.5"/>
