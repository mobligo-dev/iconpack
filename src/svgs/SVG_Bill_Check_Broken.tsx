...
const SVG_Bill_Check_Broken = (props: { className: any }) => {
...
<path d="M9.5 10.4L10.9286 12L14.5 8" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
<path d="M7.5 15.5H9M16.5 15.5H12" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
