...
const SVG_List_Arrow_Up_Broken = (props: { className: any }) => {
...
<path d="M20 16.5L17.5 14M17.5 14L15 16.5M17.5 14V20" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
