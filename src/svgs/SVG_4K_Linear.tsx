...
const SVG_4K_Linear = (props: { className: any }) => {
...
<path d="M5.5 8V10C5.5 11.1046 6.39543 12 7.5 12H10.5M10.5 8V12M10.5 12V16M13.5 8V13.2M13.5 13.2V16M13.5 13.2L15.4231 11.2M15.4231 11.2L18.5 8M15.4231 11.2L18.5 16" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
