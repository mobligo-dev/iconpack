...
const SVG_Folder_Path_Connect_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M16.5 7.5L13.5 7.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M22 20H14M2 20H10" stroke-linecap="round" stroke-width="1.5"/>
<path d="M12 18V15" stroke-linecap="round" stroke-width="1.5"/>
