...
const SVG_Bag_Music_2_Linear = (props: { className: any }) => {
...
<path d="M13 16V13V10" stroke-linecap="round" stroke-width="1.5"/>
<circle cx="11" cy="16" r="2" stroke="black" stroke-width="1.5"/>
<path d="M15 12C13.8954 12 13 11.1046 13 10" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
