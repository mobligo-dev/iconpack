...
const SVG_Bell_Off_Linear = (props: { className: any }) => {
...
<path d="M7.5 19C8.15503 20.7478 9.92246 22 12 22C14.0775 22 15.845 20.7478 16.5 19" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
