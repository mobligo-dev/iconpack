...
const SVG_Clound_Cross_Broken = (props: { className: any }) => {
...
<path d="M13.5 17.5L12 19M12 19L10.5 20.5M12 19L10.5 17.5M12 19L13.5 20.5" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
