...
const SVG_Cart_Large_3_Broken = (props: { className: any }) => {
...
<path d="M16.5 6.5L15 15.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M9 6.5L10.5 15" stroke-linecap="round" stroke-width="1.5"/>
