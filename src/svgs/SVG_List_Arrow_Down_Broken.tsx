...
const SVG_List_Arrow_Down_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M15 17.5L17.5 20M17.5 20L20 17.5M17.5 20V14" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
