...
const SVG_Bill_List_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M10.5 11L17 11" stroke-linecap="round" stroke-width="1.5"/>
<path d="M7 11H7.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M7 7.5H7.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M7 14.5H7.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M17 14.5H16M10.5 14.5H13.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M17 7.5H14M10.5 7.5H11.5" stroke-linecap="round" stroke-width="1.5"/>
