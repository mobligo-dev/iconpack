...
const SVG_Chart_Square_Linear = (props: { className: any }) => {
...
<path d="M7 18V9" stroke-linecap="round" stroke-width="1.5"/>
<path d="M12 18V6" stroke-linecap="round" stroke-width="1.5"/>
<path d="M17 18V13" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
