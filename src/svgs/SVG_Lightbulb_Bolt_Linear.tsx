...
const SVG_Lightbulb_Bolt_Linear = (props: { className: any }) => {
...
<path d="M12.7856 8.5L10.6427 11.5H13.6427L11.4999 14.5" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
</svg>
    );
};
