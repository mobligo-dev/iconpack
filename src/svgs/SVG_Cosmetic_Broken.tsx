...
const SVG_Cosmetic_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M16.5 16C13.4624 16 11 13.5376 11 10.5C11 7.46243 13.4624 5 16.5 5C19.5376 5 22 7.46243 22 10.5C22 12.0347 21.3714 13.4227 20.3576 14.4203" stroke-linecap="round" stroke-width="1.5"/>
<path d="M16.5 20V16M16.5 20H19.5M16.5 20H13.5" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
...
<path d="M3 11H7V5.61799C7 4.87461 6.21769 4.39111 5.55279 4.72356L3.55279 5.72356C3.214 5.89295 3 6.23922 3 6.61799V11Z" stroke-width="1.5"/>
</svg>
    );
};
