...
const SVG_User_Cross_Rounded_Linear = (props: { className: any }) => {
...
<path d="M15.6665 16.6665L18.3332 19.3332M18.3335 16.6665L15.6668 19.3332" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
</svg>
    );
};
