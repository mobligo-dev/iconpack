...
const SVG_Banknote_Linear = (props: { className: any }) => {
...
<path d="M5.5 15L5.5 9" stroke-linecap="round" stroke-width="1.5"/>
<path d="M18.5 15L18.5 9" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};

export default SVG_Banknote_Linear;
