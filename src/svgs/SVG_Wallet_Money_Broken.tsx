...
const SVG_Wallet_Money_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M6 10H10" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
...
<circle cx="18" cy="14" fill="black" r="1"/>
...
<path d="M6 6L9.73549 3.52313C10.7874 2.82562 12.2126 2.82562 13.2645 3.52313L17 6" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
