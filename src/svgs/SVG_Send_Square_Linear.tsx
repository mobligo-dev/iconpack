...
const SVG_Send_Square_Linear = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M17 12L10 12M10 12L13 15M10 12L13 9" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
<path d="M7 16L7 8" stroke-linecap="round" stroke-width="1.5"/>
