...
const SVG_Bowling_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="7" r="1.5" stroke="black" stroke-width="1.5" transform="rotate(-90 12 7)"/>
<circle cx="12" cy="12" r="1.5" stroke="black" stroke-width="1.5" transform="rotate(-90 12 12)"/>
