...
const SVG_Shop_2_Linear = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M22 22H2" stroke-linecap="round" stroke-width="1.5"/>
<path d="M20 22V11" stroke-linecap="round" stroke-width="1.5"/>
<path d="M4 22V11" stroke-linecap="round" stroke-width="1.5"/>
...
<path d="M9.5 21.5V18.5C9.5 17.5654 9.5 17.0981 9.70096 16.75C9.83261 16.522 10.022 16.3326 10.25 16.201C10.5981 16 11.0654 16 12 16C12.9346 16 13.4019 16 13.75 16.201C13.978 16.3326 14.1674 16.522 14.299 16.75C14.5 17.0981 14.5 17.5654 14.5 18.5V21.5" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
