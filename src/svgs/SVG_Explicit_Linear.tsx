...
const SVG_Explicit_Linear = (props: { className: any }) => {
...
<path d="M15 7H10C9.44772 7 9 7.44772 9 8V12M15 17H10C9.44772 17 9 16.5523 9 16V12M9 12H15" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
