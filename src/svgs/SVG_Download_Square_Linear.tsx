...
const SVG_Download_Square_Linear = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 7L12 14M12 14L15 11M12 14L9 11" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
<path d="M16 17H12H8" stroke-linecap="round" stroke-width="1.5"/>
