...
const SVG_Key_Minimalistic_Square_3_Linear = (props: { className: any }) => {
...
<path d="M11 12H15.5M15.5 12H17C17.5523 12 18 12.4477 18 13V14M15.5 12V13.5" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
