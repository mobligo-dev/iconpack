...
const SVG_Traffic_Economy_Linear = (props: { className: any }) => {
...
<path d="M14.5 2.31494C18.014 3.21939 20.7805 5.98588 21.685 9.4999" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
