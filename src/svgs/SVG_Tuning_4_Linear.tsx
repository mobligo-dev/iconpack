...
const SVG_Tuning_4_Linear = (props: { className: any }) => {
    ...
    return (
        ...
        <svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="2" stroke-width="1.5" transform="rotate(-90 12 12)" />
            <circle cx="10" cy="20" r="2" stroke-width="1.5" transform="rotate(-90 10 20)" />
            <circle r="2" stroke-width="1.5" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 14 4)" />
