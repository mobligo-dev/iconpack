...
const SVG_Upload_Square_Linear = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 17L12 10M12 10L15 13M12 10L9 13" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
<path d="M16 7H12H8" stroke-linecap="round" stroke-width="1.5"/>
