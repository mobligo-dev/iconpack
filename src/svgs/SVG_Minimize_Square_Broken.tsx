...
const SVG_Minimize_Square_Broken = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M20 4L14 10M14 10H17.75M14 10V6.25" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
<path d="M4 20L10 14M10 14H6.25M10 14V17.75" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
