...
const SVG_Camera_Minimalistic_Broken = (props: { className: any }) => {
...
<path d="M18 10H17.5" stroke-linecap="round" stroke-width="1.5"/>
<path d="M14.5 3.5H9.5" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
