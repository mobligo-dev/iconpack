...
const SVG_Gallery_Round_Broken = (props: { className: any }) => {
...
<path d="M22.0001 13.385L21.0266 13.2502C18.1829 12.8564 15.6098 14.2722 14.2847 16.5005" stroke-linecap="round" stroke-width="1.5"/>
