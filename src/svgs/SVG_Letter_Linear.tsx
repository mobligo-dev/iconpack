...
const SVG_Letter_Linear = (props: { className: any }) => {
...
<path d="M6 8L8.1589 9.79908C9.99553 11.3296 10.9139 12.0949 12 12.0949C13.0861 12.0949 14.0045 11.3296 15.8411 9.79908L18 8" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
