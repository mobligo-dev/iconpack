...
const SVG_Bag_3_Broken = (props: { className: any }) => {
...
<path d="M9.1709 8C9.58273 9.16519 10.694 10 12.0002 10C13.3064 10 14.4177 9.16519 14.8295 8" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
