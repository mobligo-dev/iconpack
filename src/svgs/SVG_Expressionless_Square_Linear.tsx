...
const SVG_Expressionless_Square_Linear = (props: { className: any }) => {
    const { className } = props;

    return (
        
<svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M9 16C10 16 10.8846 16 12 16C13.1154 16 14 16 15 16" stroke-linecap="round" stroke-width="1.5"/>
