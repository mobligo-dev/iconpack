...
const SVG_Maximize_Square_Broken = (props: { className: any }) => {
...
<path d="M12 12L7 17M7 17H10.75M7 17V13.25" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
