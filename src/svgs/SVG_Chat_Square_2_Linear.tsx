...
const SVG_Chat_Square_2_Linear = (props: { className: any }) => {
...
<path d="M7 18L7 15" stroke-linecap="round" stroke-width="1.5"/>
<path d="M12 18V12" stroke-linecap="round" stroke-width="1.5"/>
<path d="M17 18V9" stroke-linecap="round" stroke-width="1.5"/>
</svg>
    );
};
