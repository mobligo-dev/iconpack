...
const SVG_Suitcase_Broken = (props: { className: any }) => {
...
<path d="M17 9C17 9.55228 16.5523 10 16 10C15.4477 10 15 9.55228 15 9C15 8.44772 15.4477 8 16 8C16.5523 8 17 8.44772 17 9Z"/>
