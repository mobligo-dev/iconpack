...
const SVG_Bomb_Emoji_Linear = (props: { className: any }) => {
    const { className } = props;

    return (

        <svg className={className} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <circle cx="9.5" cy="14.5" r="7.5" stroke-width="1.5" />
            <path d="M10 16L12 16" stroke-linecap="round" stroke-width="1.5" />
            <path d="M14 12.5C14 13.3284 13.5523 14 13 14C12.4477 14 12 13.3284 12 12.5C12 11.6716 12.4477 11 13 11C13.5523 11 14 11.6716 14 12.5Z" />
            <ellipse cx="9" cy="12.5" rx="1" ry="1.5" />
